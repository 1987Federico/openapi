...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NaranjaCustomerApiTesting.Personaldetails2();
  });
  ...
  describe('Personaldetails2', function() {
    it('should create an instance of Personaldetails2', function() {
      // uncomment below and update the code to test Personaldetails2
      //var instance = new NaranjaCustomerApiTesting.Personaldetails2();
      //expect(instance).to.be.a(NaranjaCustomerApiTesting.Personaldetails2);
    });
    ...
    it('should have the property relationshipCode (base name: "relationship_code")', function() {
      // uncomment below and update the code to test the property relationshipCode
      //var instance = new NaranjaCustomerApiTesting.Personaldetails2();
      //expect(instance).to.be();
    });
