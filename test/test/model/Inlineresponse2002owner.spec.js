...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NaranjaCustomerApiTesting.Inlineresponse2002owner();
  });
  ...
  describe('Inlineresponse2002owner', function() {
    it('should create an instance of Inlineresponse2002owner', function() {
      // uncomment below and update the code to test Inlineresponse2002owner
      //var instance = new NaranjaCustomerApiTesting.Inlineresponse2002owner();
      //expect(instance).to.be.a(NaranjaCustomerApiTesting.Inlineresponse2002owner);
    });
