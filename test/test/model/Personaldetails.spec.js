...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NaranjaCustomerApiTesting.Personaldetails();
  });
  ...
  describe('Personaldetails', function() {
    it('should create an instance of Personaldetails', function() {
      // uncomment below and update the code to test Personaldetails
      //var instance = new NaranjaCustomerApiTesting.Personaldetails();
      //expect(instance).to.be.a(NaranjaCustomerApiTesting.Personaldetails);
    });
