...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NaranjaCustomerApiTesting.Jobdetails2();
  });
  ...
  describe('Jobdetails2', function() {
    it('should create an instance of Jobdetails2', function() {
      // uncomment below and update the code to test Jobdetails2
      //var instance = new NaranjaCustomerApiTesting.Jobdetails2();
      //expect(instance).to.be.a(NaranjaCustomerApiTesting.Jobdetails2);
    });
