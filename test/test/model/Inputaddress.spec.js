...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NaranjaCustomerApiTesting.Inputaddress();
  });
  ...
  describe('Inputaddress', function() {
    it('should create an instance of Inputaddress', function() {
      // uncomment below and update the code to test Inputaddress
      //var instance = new NaranjaCustomerApiTesting.Inputaddress();
      //expect(instance).to.be.a(NaranjaCustomerApiTesting.Inputaddress);
    });
