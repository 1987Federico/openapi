...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NaranjaCustomerApiTesting.Inlineresponse2002guarantors();
  });
  ...
  describe('Inlineresponse2002guarantors', function() {
    it('should create an instance of Inlineresponse2002guarantors', function() {
      // uncomment below and update the code to test Inlineresponse2002guarantors
      //var instance = new NaranjaCustomerApiTesting.Inlineresponse2002guarantors();
      //expect(instance).to.be.a(NaranjaCustomerApiTesting.Inlineresponse2002guarantors);
    });
