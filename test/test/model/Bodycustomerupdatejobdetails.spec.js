...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NaranjaCustomerApiTesting.Bodycustomerupdatejobdetails();
  });
  ...
  describe('Bodycustomerupdatejobdetails', function() {
    it('should create an instance of Bodycustomerupdatejobdetails', function() {
      // uncomment below and update the code to test Bodycustomerupdatejobdetails
      //var instance = new NaranjaCustomerApiTesting.Bodycustomerupdatejobdetails();
      //expect(instance).to.be.a(NaranjaCustomerApiTesting.Bodycustomerupdatejobdetails);
    });
