...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NaranjaCustomerApiTesting.Address2();
  });
  ...
  describe('Address2', function() {
    it('should create an instance of Address2', function() {
      ...
      //var instance = new NaranjaCustomerApiTesting.Address2();
      //expect(instance).to.be.a(NaranjaCustomerApiTesting.Address2);
    });
