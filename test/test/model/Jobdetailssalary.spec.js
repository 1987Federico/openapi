...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NaranjaCustomerApiTesting.Jobdetailssalary();
  });
  ...
  describe('Jobdetailssalary', function() {
    it('should create an instance of Jobdetailssalary', function() {
      // uncomment below and update the code to test Jobdetailssalary
      //var instance = new NaranjaCustomerApiTesting.Jobdetailssalary();
      //expect(instance).to.be.a(NaranjaCustomerApiTesting.Jobdetailssalary);
    });
