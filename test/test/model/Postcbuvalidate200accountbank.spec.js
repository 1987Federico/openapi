...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NaranjaCustomerApiTesting.Postcbuvalidate200accountbank();
  });
  ...
  describe('Postcbuvalidate200accountbank', function() {
    it('should create an instance of Postcbuvalidate200accountbank', function() {
      // uncomment below and update the code to test Postcbuvalidate200accountbank
      //var instance = new NaranjaCustomerApiTesting.Postcbuvalidate200accountbank();
      //expect(instance).to.be.a(NaranjaCustomerApiTesting.Postcbuvalidate200accountbank);
    });
