...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NaranjaCustomerApiTesting.Account();
  });
  ...
  describe('Account', function() {
    it('should create an instance of Account', function() {
      ...
      //var instance = new NaranjaCustomerApiTesting.Account();
      //expect(instance).to.be.a(NaranjaCustomerApiTesting.Account);
    });
