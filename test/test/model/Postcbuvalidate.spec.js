...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NaranjaCustomerApiTesting.Postcbuvalidate();
  });
  ...
  describe('Postcbuvalidate', function() {
    it('should create an instance of Postcbuvalidate', function() {
      // uncomment below and update the code to test Postcbuvalidate
      //var instance = new NaranjaCustomerApiTesting.Postcbuvalidate();
      //expect(instance).to.be.a(NaranjaCustomerApiTesting.Postcbuvalidate);
    });
